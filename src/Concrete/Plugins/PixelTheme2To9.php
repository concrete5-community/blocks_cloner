...
class PixelTheme2To9 implements ConvertExport, ConvertImport
{
    ...
    public function getExportConverters()
    {
        ...
        $converter
            ->addBlockType('whale_cta', Export\BlockType::create()
    ...
    public function getImportConverters()
    {
        ...
        $converter
            ->addBlockType('autonav', Import\BlockType::create()
                ->addTemplateRemapping('pixel_breadcrumb', '')
                ->addTemplateRemapping('pixel_tree', '')
            )
            ->addBlockType('content', Import\BlockType::create()
            ...
            ->addBlockType('date_navigation', Import\BlockType::create()
                ->addTemplateRemapping('pixel_list', '')
            )
            ->addBlockType('express_entry_detail', Import\BlockType::create()
            ...
            ->addBlockType('express_entry_list', Import\BlockType::create()
            ...
            ->addBlockType('faq', Import\BlockType::create()
            ...
            ->addBlockType('feature', Import\BlockType::create()
            ...
            ->addBlockType('file', Import\BlockType::create()
            ...
            ->addBlockType('form', Import\BlockType::create()
                ->addTemplateRemapping('pixel_subscribe', '')
            )
            ->addBlockType('horizontal_rule', Import\BlockType::create()
            ...
            ->addBlockType('html', Import\BlockType::create()
                ->addTemplateRemapping('pixel_test_bordered', '')
                ->addTemplateRemapping('pixel_test', '')
                ->addTemplateRemapping('pixel_test-2', '')
            )
            ->addBlockType('image_slider', Import\BlockType::create()
                ->addTemplateRemapping('pixel_owl', '')
            )
            ->addBlockType('manual_nav', Import\BlockType::create()
                ->addTemplateRemapping('pixel_top_bar', '')
            )
            ->addBlockType('next_previous', Import\BlockType::create()
                ->addTemplateRemapping('pixel_post_nav', '')
            )
            ->addBlockType('page_attribute_display', Import\BlockType::create()
                ->addTemplateRemapping('pixel_image_responsive_full', 'pixel_image_responsive')
            )
            ->addBlockType('page_list', Import\BlockType::create()
            ...
            ->addBlockType('page_title', Import\BlockType::create()
            ...
            ->addBlockType('search', Import\BlockType::create()
                ->addTemplateRemapping('pixel_grouped', '')
            )
            ->addBlockType('social_links', Import\BlockType::create()
                ->addTemplateRemapping('pixel_footer_icons', '')
                ->addTemplateRemapping('pixel_top_bar', '')
            )
            ->addBlockType('survey', Import\BlockType::create()
                ->addTemplateRemapping('pixel', '')
            )
            ->addBlockType('testimonial', Import\BlockType::create()
                ->addTemplateRemapping('pixel_grid', 'pixel')
                ->addTemplateRemapping('pixel_list', 'pixel', 'layout:center')
            )
            ->addBlockType('topic_list', Import\BlockType::create()
                ->addTemplateRemapping('pixel_filter', '')
                ->addTemplateRemapping('pixel_filter_js', '')
                ->addTemplateRemapping('pixel_list', '')
            )
            ->addBlockType('video', Import\BlockType::create()
                ->addTemplateRemapping('pixel', '')
            )
            ->addBlockType('whale_chart', Import\BlockType::create()
            ...
            ->addBlockType('whale_counter', Import\BlockType::create()
            ...
            ->addBlockType('whale_cta', Import\BlockType::create()
            ...
            ->addBlockType('whale_gallery', Import\BlockType::create()
            ...
            ->addBlockType('whale_manual_nav', Import\BlockType::create()
            ...
            ->addBlockType('whale_pricing_table', Import\BlockType::create()
